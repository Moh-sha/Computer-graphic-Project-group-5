...
void _star(float x=0,float y=0,float _size=1)/// TAMIM
{
    glPointSize(3);
...
void handleKeypress(unsigned char key, int x, int y) { /// TAMIM
	switch (key) {
	    case  'd':  ///day
	        glutDestroyWindow(1);
